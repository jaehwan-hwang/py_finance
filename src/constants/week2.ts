...
export const WEEK2: WeekContent = {
  cover: {
    lead: "금융공학의 출발점은 <b>지금의 100만원과 1년 뒤의 100만원은 다르다</b> 한 문장입니다. 이 문장을 코드로 옮기면서 조건문·반복문·함수를 익힙니다.",
    goal: "반복문으로 복리 계산기를 직접 만든다.",
  },
...
print(f"수익률 {0.6289:+.1%}")   # 수익률 +62.9%`,
...

    {
      ...
      callout: {
        kind: "tip",
        title: "막히면",
        body: "먼저 <b>1년치만</b> 손으로 계산해 보세요. 그다음 그 계산을 반복문으로 옮기면 됩니다. 혼자 30분 이상 붙잡지 마세요.",
      },
    },
  ],
