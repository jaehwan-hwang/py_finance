...
export const WEEK7: WeekContent = {
  cover: {
    lead: "함수 모듈화와 csv 입출력을 배우고, 증권사 API 로 모의계좌에 주문을 집행합니다.",
  },

  slides: [
    {
      title: "시작 전 — 준비물 확인",
      lead: "아래 세 가지가 갖춰져 있어야 주문을 넣을 수 있습니다.",
      bullets: [
...
saved = pd.read_csv("orders_2026-11-04.csv", dtype={"ticker": str})`,
    ...
    {
      title: "덤 — 클래스 맛보기",
      lead: "함수가 많아지면 관련된 것끼리 묶게 됩니다. 그게 클래스입니다.",
      codes: [
        {
...
print(p.to_orders({"005930": 70000, "000660": 180000}))`,
          caption: "self 는 인스턴스 자기 자신을 가리킵니다. 8주차 심화 주제입니다.",
        },
      ],
    },
  ...
  nextPreview:
    "마지막 주는 자율 진행입니다. 각자 포트폴리오를 구성하고, 근거와 한계를 정리해 발표합니다.",
};
