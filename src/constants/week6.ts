...
export const WEEK6: WeekContent = {
  cover: {
    lead: "행렬 연산과 몬테카를로로 비중 1만 세트를 만들어 효율적 투자선과 최대 샤프 조합을 찾습니다.",
  },
...
print(w.shape)                            # (4,)`,
      ...
      callout: {
        kind: "tip",
        title: "먼저 2×2 로 손계산",
        body: "2×2 행렬 곱을 손으로 한 번 해본 뒤 코드로 넘어갑니다.",
      },
    },
...
print(w, w.sum())      # 합 1.0`,
...

    {
      ...
      lead: "수학으로 푸는 대신 <b>가능한 조합을 잔뜩 만들어 보고</b> 그중 제일 좋은 것을 고릅니다.",
      codes: [
        {
...
for name, w in [("동일가중", equal), ("최대샤프", results[best][3])]:
    ...
    print(f"{name}  수익 {r:.2%}  위험 {v:.2%}  샤프 {(r-0.035)/v:.2f}")`,
      ...
      callout: {
        ...
        body: "기대수익률에 <b>±1%p 만 노이즈를 줘도</b> 최적 비중이 크게 흔들립니다. 동일가중이 실무에서 계속 쓰이는 이유입니다.",
      },
    },
...
print(res.x.round(3))`,
...

    {
      ...
      callout: {
        kind: "warn",
        title: "다음 주 준비물",
        body: "7주차에는 이 비중으로 모의계좌에 주문을 넣습니다. <b>모의투자 신청과 앱키 발급은 승인에 며칠 걸리므로 이번 주에 미리</b> 해두세요.",
      },
    },
  ],
